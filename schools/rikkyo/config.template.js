(function(root){
'use strict';
// NON-DEPLOYABLE TEMPLATE.
// Do not rename this file to config.js until Rikkyo scoring/goal authority is established.
root.ENGLISH_SCHOOL_CONFIG=Object.freeze({
  ...
  exam:Object.freeze({
    ...
    route:Object.freeze([2024,2025,2026]),
    defaultYear:2024,
    goalTiers:Object.freeze([]),
    defaultGoal:null,
    writtenMaxScore:null,
    listeningMaxScore:null,
    totalMaxScore:null,
    dailyTaskTarget:10,
    paperIds:Object.freeze(['FY24A','FY24B','FY25A','FY25B','FY26A','FY26B']),
    paperRoute:Object.freeze([]),
  ...
  progress:Object.freeze({enabled:false,endpoint:'',appId:'rikkyo-english'}),
  aiWriting:Object.freeze({enabled:false,endpoint:'',skills:Object.freeze([])})
});
