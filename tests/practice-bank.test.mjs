...
assert.equal(new Set(bank.items.map(x=>x.id)).size,42);
...
for(const skill of ['guided_completion','word_order','error_correction_rewrite','long_reading','paraphrase','short_text_multiple_choice','reading_short_answer']){
